...
SUP_BUTTONS = [
    [
        Button.url("• Repo •", url="https://github.com/rogerpq/Ultroid"),
        Button.url("• Support •", url="t.me/Repthon_support"),
    ],
]
...
async def inline_alive(o):
    TLINK = inline_pic() or "https://graph.org/file/b3e0cb631d36672092852.jpg"
    MSG = "• **سورس ريبثون •**"
    WEB0 = InputWebDocument(
        "https://graph.org/file/b3e0cb631d36672092852.jpg", 0, "image/jpg", []
    )
    RES = [
